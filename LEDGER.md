...
- **Evan's Hurt and I'm Sick are one button (Frank, 3 Sep 2026).** The
  Hurt tile opens the body map with the sick symptoms under it on the
  same board, and back goes home (it used to land on the I'm Sick board,
  which he called weird). My Choice moved inside Feelings, after
  Overstimmed. Evan's home is twelve tiles: Family, Food / School,
  Sentence Build / Places, TV / Feelings, Bathroom / Morning, Night /
...
- **Frank's rulings on the subscription and the family, 5 Sep 2026:**
  ...
  stays free; everyday texting sits on the subscription; the alert
...
- **Phrase screens open like boards (Frank, 4 Sep 2026, both apps).**
  ...
  Then: a phrase screen opened from the home board (Bathroom) also swaps
